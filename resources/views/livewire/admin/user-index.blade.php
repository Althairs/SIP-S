    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-3">
                <!-- Jurusan Filter -->
                <select wire:model.change="jurusanFilter" @class(['px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2', $onlyKajurSekjur ? 'focus:ring-purple-500 focus:border-purple-500' : 'focus:ring-green-500 focus:border-green-500', 'text-gray-400' => !$jurusanFilter, 'text-gray-900' => $jurusanFilter])>
                ...
                @if(!$onlyKajurSekjur)
                <select wire:model.change="prodiFilter" @class(['px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500', 'text-gray-400' => !$prodiFilter, 'text-gray-900' => $prodiFilter])>
                ...
                <!-- Role Filter -->
                <select wire:model.change="roleFilter" @class(['px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2', $onlyKajurSekjur ? 'focus:ring-purple-500 focus:border-purple-500' : 'focus:ring-green-500 focus:border-green-500', 'text-gray-400' => !$roleFilter, 'text-gray-900' => $roleFilter])>
                ...
                <!-- Status Filter -->
                <select wire:model.change="statusFilter" @class(['px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2', $onlyKajurSekjur ? 'focus:ring-purple-500 focus:border-purple-500' : 'focus:ring-green-500 focus:border-green-500', 'text-gray-400' => $statusFilter === '', 'text-gray-900' => $statusFilter !== ''])>
