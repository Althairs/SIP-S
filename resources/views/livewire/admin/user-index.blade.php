<div>
    ...
    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <span class="text-sm font-medium text-gray-700">Data terpilih dari tabel</span>
        </div>
        <div class="flex items-center gap-2">
            ...
            <button wire:click="bulkDelete"
                    wire:confirm="Apakah Anda yakin ingin menghapus {{ count($selected) }} user terpilih?"
                    wire:loading.attr="disabled"
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 {{ in_array((string)$user->id, $selected) ? 'bg-green-50/50' : '' }}">
                        <td class="px-4 py-4 text-center">
                            <input type="checkbox" wire:model.live="selected" value="{{ $user->id }}" class="rounded border-gray-300 text-green-600 focus:ring-green-500 cursor-pointer">
                        </td>
                        <td class="px-6 py-4">
