            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
                ...
                <li>
                    <div class="flex items-center">
                        ...
                        <span class="text-rose-700 font-medium">Tambah</span>
                    </div>
                </li>
            </ol>
        </nav>
        ...
        <form wire:submit="save">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text"
                           ...
                           placeholder="Contoh: panitia_seminar">
                    <p class="mt-1 text-xs text-gray-500">Gunakan underscore untuk spasi, contoh: "kajur", "dosen_pembimbing"</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                ...
                <div class="mt-6 pt-4 border-t border-gray-200">
                    <button type="button"
                            onclick="event.preventDefault(); toggleAll()"
                            class="text-sm text-rose-700 hover:text-rose-800 font-medium">
