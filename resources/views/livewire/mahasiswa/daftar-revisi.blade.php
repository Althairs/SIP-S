    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
            <div class="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-10 h-10 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
            </div>
                ...
                <table class="w-full">
                    ...
                    <tbody class="divide-y divide-gray-100">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                <span class="px-2 py-1 bg-{{ $revisi->kategori_color ?? 'blue' }}-100 text-{{ $revisi->kategori_color ?? 'blue' }}-800 rounded-full text-xs font-medium">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @elseif($revisi->status == 'diperiksa')
                                    <span class="px-2.5 py-1 bg-blue-100 text-blue-800 rounded-full text-xs font-medium">Diperiksa</span>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <button wire:click="selectRevisi({{ $revisi->id }})" class="text-blue-600 hover:text-blue-800 font-medium text-sm flex items-center gap-1">
    ...
    @if($selectedRevisiId)
        ...
        <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
            <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                <div class="fixed inset-0 bg-gray-900/50 backdrop-blur-xs transition-opacity" wire:click="closeModal"></div>

                <span class="hidden sm:inline-block sm:align-middle sm:h-screen" aria-hidden="true">&#8203;</span>

                <div class="relative z-10 inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-3xl sm:w-full">
                    ...
                    <div class="px-6 py-5 max-h-[80vh] overflow-y-auto">
                        ...
                        <div class="mb-5 bg-blue-50 p-4 rounded-xl border border-blue-100">
                            <p class="text-xs text-blue-600 font-medium mb-2">File Revisi yang Diunggah</p>
                            <div class="flex items-center justify-between">
                                <a href="{{ asset('storage/' . $revisi->file_revisi_mahasiswa) }}" target="_blank" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm">
                        ...
                        <div class="mb-5 bg-purple-50 p-4 rounded-xl border border-purple-100">
                            <p class="text-xs text-purple-600 font-medium mb-1">Catatan Review dari Dosen</p>
                        ...
                        <div class="mt-6 border-t border-gray-200 pt-5">
                            ...
                            <form wire:submit="uploadRevisi">
                                <div class="mb-4">
                                    ...
                                    <input type="file" wire:model="file_revisi" class="block w-full text-sm text-gray-500 border border-gray-300 rounded-xl cursor-pointer overflow-hidden bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 file:mr-4 file:py-3 file:px-5 file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 file:cursor-pointer transition">
                                    @error('file_revisi') <span class="text-red-500 text-xs mt-1 block">{{ $message }}</span> @enderror
                                </div>

                                <div class="mb-4">
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Catatan Tambahan (Opsional)</label>
                                    <textarea wire:model="catatan_mahasiswa" rows="3" class="w-full border border-gray-300 rounded-xl focus:ring-2 focus:ring-blue-500 p-3 text-sm" placeholder="Tambahkan catatan untuk dosen..."></textarea>
                                </div>

                                <div class="flex justify-end gap-3">
                                    <button type="button" wire:click="closeModal" class="px-5 py-2 bg-gray-200 text-gray-700 rounded-xl hover:bg-gray-300 transition text-sm font-medium">
                                        Batal
                                    </button>
                                    <button type="submit" class="px-5 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition shadow-sm font-medium text-sm flex items-center gap-2">
