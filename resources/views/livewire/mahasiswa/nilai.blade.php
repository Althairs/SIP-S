<div>
    ...
    <nav class="mb-6 flex items-center text-sm text-gray-500">
        ...
        @if($showDetail && $selectedUjian)
            <a href="#" wire:click="closeDetail" class="text-green-600 hover:text-green-700 font-medium">Nilai</a>
            <svg class="w-4 h-4 mx-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            <div class="flex items-center justify-between">
                ...
                <div class="w-12 h-12 bg-green-100 rounded-xl flex items-center justify-center">
                    <svg class="w-6 h-6 text-green-700" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"/></svg>
                </div>
            </div>
        </div>
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 text-center">
                            <button wire:click="showDetailNilai({{ $nilai->id }})" class="text-sm text-green-700 hover:text-green-800 font-medium">Lihat Detail</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="mt-6 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-3">
            ...
            <div class="bg-green-50 rounded-xl p-3 text-center">
                <p class="text-2xl font-bold text-green-800">B</p>
                <p class="text-xs text-green-600">70 - 84</p>
                <p class="text-xs text-green-500">Baik</p>
            </div>
            ...
            <div class="bg-green-50 rounded-xl p-3 text-center">
                <p class="text-2xl font-bold text-green-800">D</p>
                <p class="text-xs text-green-600">50 - 54</p>
                <p class="text-xs text-green-500">Kurang</p>
            </div>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-green-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-600 to-green-800 p-6 text-white">
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="bg-gradient-to-r from-green-50 to-green-50 rounded-2xl p-6 border border-green-200">
                        <h3 class="text-lg font-bold text-green-800 mb-4 text-center">Hasil Akhir Ujian</h3>
                        <div class="grid grid-cols-3 gap-6 text-center">
                            <div>
                                <p class="text-sm text-green-600 mb-1">Nilai Akhir</p>
                                <p class="text-5xl font-bold text-green-800">{{ $selectedUjian->nilai_total }}</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                @endphp
                                <p class="text-2xl font-bold {{ $statusLulus ? 'text-green-600' : 'text-red-600' }} flex items-center">
                                    @if($statusLulus)
                    ...
                    <div class="border border-green-200 rounded-2xl overflow-hidden">
                        <div class="bg-green-50 px-6 py-3 border-b border-green-200">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-green-600">{{ $p1['nama'] }} (NIP: {{ $p1['nip'] }})</p>
                                </div>
                        ...
                        <div class="p-6">
                            <table class="w-full">
                                ...
                                <tbody class="divide-y text-sm">
                                    ...
                                    <tr class="bg-green-50 font-bold">
                                        ...
                                        <td class="px-4 py-3 text-center text-green-800 text-lg">{{ number_format($totalNilaiAkhirP1, 1) }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            ...
                            <div class="mt-4 p-3 bg-gray-50 rounded-xl text-xs text-gray-600">
                                ...
                                <p class="font-bold text-green-700 mt-1">NA Penguji 1 = {{ number_format($totalNilaiAkhirP1, 1) }}</p>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="bg-amber-50 border border-amber-200 rounded-xl p-4">
                        <p class="text-sm font-medium text-amber-800 inline-flex items-center gap-1">
