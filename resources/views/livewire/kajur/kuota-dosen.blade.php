                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-4">
                            <div class="flex items-center gap-2">
                                <button wire:click="openEditModal({{ $dosen->id }})" class="px-3 py-1.5 bg-rose-50 text-rose-700 rounded-lg hover:bg-rose-100 text-sm font-medium">Edit Kuota</button>
        ...
        <div class="flex items-center justify-center min-h-screen px-4">
            ...
            <div class="relative bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
                ...
                <div class="mb-4 p-3 bg-gray-50 rounded-xl">
                    ...
                    <p class="text-xs text-gray-500">NIP: {{ $editNip }}</p>
                </div>
                ...
                <form wire:submit="saveKuota">
                    <div class="space-y-4">
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" wire:model="editKuotaPembimbing" min="1" max="20"
                            ...
                            <div>
                                ...
                                <input type="number" wire:model="editKuotaPenguji" min="1" max="30"
                    ...
                    <div class="mt-6 flex justify-end gap-4">
                        <button type="button" wire:click="closeEditModal" class="px-6 py-2.5 border border-gray-300 text-gray-700 rounded-xl hover:bg-gray-50 font-medium">Batal</button>
