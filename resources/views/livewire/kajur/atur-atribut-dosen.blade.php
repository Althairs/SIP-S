<div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 mb-6">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <select wire:model.change="kepakaranFilter" class="px-4 py-2.5 border border-gray-300 rounded-xl">
            ...
            <select wire:model.change="bidangFilter" class="px-4 py-2.5 border border-gray-300 rounded-xl">
