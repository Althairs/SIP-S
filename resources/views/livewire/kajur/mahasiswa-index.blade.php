    ...
    @if($showImportView)
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
            ...
            <form wire:submit.prevent="importExcel" class="space-y-6">
                ...
                @if($file)
                    <div class="flex items-center justify-between p-4 bg-purple-50 text-purple-700 rounded-xl border border-purple-100">
                        ...
                        <button type="button" wire:click="$set('file', null)" class="text-purple-500 hover:text-purple-700">
                            Hapus
                        </button>
                    </div>
                @endif
                ...
                <!-- Requirements Info -->
                <div class="p-4 bg-blue-50 border border-blue-200 text-blue-800 rounded-xl">
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                        @foreach(['No', 'Nama', 'NIM', 'Fakultas', 'Prodi', 'Status Awal', 'Semester Awal Terdaftar', 'Status Aktif'] as $col)
                            <span class="px-2.5 py-1 bg-blue-100 text-blue-800 rounded-md text-xs font-semibold">{{ $col }}</span>
                        @endforeach
                    </div>
                </div>
                ...
                <div class="flex justify-end gap-3">
                    ...
                    <button type="submit" class="px-6 py-2.5 bg-purple-700 text-white rounded-xl hover:bg-purple-800 transition font-medium flex items-center gap-2" wire:loading.attr="disabled" wire:target="file, importExcel">
