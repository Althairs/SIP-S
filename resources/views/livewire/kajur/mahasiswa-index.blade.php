<div>
    ...
    <div class="mb-6 p-4 bg-green-50 border border-green-200 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <span class="text-sm font-medium text-gray-700">Data mahasiswa terpilih</span>
        </div>
        <div class="flex items-center gap-2">
            ...
            <button wire:click="bulkDelete"
                    wire:confirm="Apakah Anda yakin ingin menghapus {{ count($selected) }} mahasiswa terpilih?"
                    wire:loading.attr="disabled"
            ...
            <table class="w-full">
                ...
                <tbody class="divide-y divide-gray-200">
                    @forelse($mahasiswas as $index => $mhs)
                        <tr class="hover:bg-gray-50 {{ in_array((string)$mhs->id, $selected) ? 'bg-green-50/50' : '' }}">
                            <td class="px-4 py-4 text-center">
                                <input type="checkbox" wire:model.live="selected" value="{{ $mhs->id }}" class="rounded border-gray-300 text-green-600 focus:ring-green-500 cursor-pointer">
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="px-6 py-8 text-center text-gray-500">Tidak ada data mahasiswa</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
