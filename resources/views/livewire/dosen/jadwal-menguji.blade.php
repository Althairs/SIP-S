                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            @if($p->file_proposal)
                            <a href="{{ asset('storage/' . $p->file_proposal) }}" target="_blank" class="px-4 py-2 bg-blue-50 text-blue-700 rounded-xl text-sm hover:bg-blue-100">📄 Proposal</a>
                            @endif
                            @if($p->file_skripsi)
                            <a href="{{ asset('storage/' . $p->file_skripsi) }}" target="_blank" class="px-4 py-2 bg-blue-50 text-blue-700 rounded-xl text-sm hover:bg-blue-100">📄 Skripsi</a>
                            @endif
                        </div>
                    </div>
                </div>
