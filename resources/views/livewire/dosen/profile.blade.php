<div>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="bg-gradient-to-r from-green-600 to-green-800 rounded-2xl p-6 mb-6 text-white">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-green-100">NIP: {{ Auth::user()->nip }}</p>
                    <p class="text-green-200 text-sm">{{ Auth::user()->jurusan?->nama_jurusan }}</p>
        ...
        <div class="flex border-b border-gray-200 mb-6">
            <button wire:click="setTab('profile')" class="px-6 py-3 text-sm font-medium border-b-2 transition {{ $activeTab === 'profile' ? 'border-green-600 text-green-700' : 'border-transparent text-gray-500 hover:text-gray-700' }}">Edit Profile</button>
            <button wire:click="setTab('password')" class="px-6 py-3 text-sm font-medium border-b-2 transition {{ $activeTab === 'password' ? 'border-green-600 text-green-700' : 'border-transparent text-gray-500 hover:text-gray-700' }}">Ubah Password</button>
            <button wire:click="setTab('info')" class="px-6 py-3 text-sm font-medium border-b-2 transition {{ $activeTab === 'info' ? 'border-green-600 text-green-700' : 'border-transparent text-gray-500 hover:text-gray-700' }}">Info Akademik</button>
        </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" wire:model="name" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Email</label>
                            <input type="email" wire:model="email" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="nomor_hp" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500">
                        </div>
                        <div class="md:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Alamat</label>
                            <textarea wire:model="alamat" rows="3" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="px-6 py-2.5 bg-green-700 text-white rounded-xl hover:bg-green-800 font-medium">Simpan Profile</button>
                </div>
            </form>
        </div>
        @endif
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <form wire:submit="updatePassword">
                ...
                <div class="mt-6">
                    <button type="submit" class="px-6 py-2.5 bg-green-700 text-white rounded-xl hover:bg-green-800 font-medium">Update Password</button>
                </div>
            </form>
        </div>
        @endif
            ...
            <div class="mt-6 pt-6 border-t">
                ...
                <div class="grid grid-cols-4 gap-4">
                    <div class="bg-green-50 rounded-xl p-3 text-center">
                        ...
                        <p class="text-lg font-bold text-green-700">{{ $kuota->kuota_pembimbing }}</p>
                    </div>
                    ...
                    <div class="bg-green-50 rounded-xl p-3 text-center">
                        ...
                        <p class="text-lg font-bold text-green-700">{{ $kuota->kuota_penguji }}</p>
                    </div>
                    <div class="bg-amber-50 rounded-xl p-3 text-center">
                        <p class="text-xs text-gray-500">Terpakai</p>
