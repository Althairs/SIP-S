<div>
    ...
    <div class="bg-gradient-to-r from-green-700 to-green-900 rounded-2xl p-6 mb-6 text-white">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-green-300 text-sm mt-2">Fokus pada rekap dokumen, revisi, dan nilai ujian. <a href="{{ route('panitia.administrasi.laporan') }}" class="underline hover:text-white">Unduh laporan PDF →</a></p>
            </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-green-100">
            ...
            <p class="text-3xl font-bold text-green-700 mt-2">{{ $totalDokumenSiap }}</p>
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-green-100">
            ...
            <p class="text-3xl font-bold text-green-700 mt-2">{{ $totalNilaiMasuk }}</p>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-3">
                <div class="rounded-xl bg-green-50 p-4">
                    <p class="text-sm font-semibold text-green-900">1. Arsipkan dokumen ujian</p>
                    <p class="text-xs text-green-700 mt-1">Prioritaskan ujian yang sudah selesai dan punya nilai.</p>
                </div>
                ...
                <div class="rounded-xl bg-green-50 p-4">
                    <p class="text-sm font-semibold text-green-900">3. Cocokkan nilai penguji</p>
                    <p class="text-xs text-green-700 mt-1">Gunakan data nilai masuk sebagai bahan rekap.</p>
                </div>
                <a href="{{ route('panitia.administrasi.profile') }}" class="block text-center px-4 py-2 bg-green-800 text-white rounded-xl hover:bg-green-900 text-sm font-medium">Buka Profil</a>
            </div>
        </div>
    </div>
