                ...
                <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
                        ...
                        <div class="mt-3 grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-1 mt-0.5">
                                    @if($p->file_proposal)
                                        <span class="px-2 py-0.5 bg-blue-100 text-blue-700 rounded text-xs">📄 Proposal</span>
                                    @endif
                                    @if($p->file_krs)
                                        <span class="px-2 py-0.5 bg-green-100 text-green-700 rounded text-xs">📋 KRS</span>
                                    @endif
                                    @if($p->file_transkrip)
                    ...
                    <div class="flex flex-col gap-2 md:flex-shrink-0">
                        ...
                        @if($p->status === 'disetujui_panitia')
                            <span
                                class="px-3 py-2 bg-green-50 text-green-700 rounded-xl text-xs text-center border border-green-200">
                        ...
                        @if($p->status === 'ditolak_panitia')
                            <span class="px-3 py-2 bg-red-50 text-red-700 rounded-xl text-xs text-center border border-red-200">
                                ❌ Ditolak
                            </span>
                        @endif
                    </div>
