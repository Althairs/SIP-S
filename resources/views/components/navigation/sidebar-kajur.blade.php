        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="{{ route('kajur.dashboard') }}" class="flex ms-2 md:me-24">
                    <div
                        class="w-8 h-8 bg-gradient-to-br from-emerald-600 to-emerald-700 rounded-lg flex items-center justify-center">
                    ...
                    <span class="self-center text-lg font-semibold whitespace-nowrap text-gray-800 ms-3">SIP-<span
                            class="text-emerald-700">S</span> <span class="text-xs text-gray-500">| Kajur</span></span>
                </a>
            </div>
                ...
                <div class="flex items-center ms-3">
                    <div>
                        <button type="button"
                            ...
                            <img class="w-8 h-8 rounded-full"
                                src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->name) }}&background=059669&color=fff"
                                alt="user photo">
                        </button>
                    </div>
                    <div class="z-50 hidden bg-white border border-gray-200 rounded-lg shadow-lg w-44"
                        ...
                        <div class="px-4 py-3 border-b border-gray-200" role="none">
                            ...
                            <span
                                class="inline-block mt-1 px-2 py-0.5 bg-emerald-100 text-emerald-800 rounded-full text-xs font-medium capitalize">Kajur</span>
                        </div>
                        <ul class="p-2 text-sm text-gray-700 font-medium" role="none">
                            <li><a href="{{ route('kajur.dashboard') }}"
                                    class="inline-flex items-center w-full p-2 hover:bg-gray-100 hover:text-gray-900 rounded"
                                    role="menuitem">Dashboard</a></li>
                            <li><a href="{{ route('kajur.profile') }}"
                                    class="inline-flex items-center w-full p-2 hover:bg-gray-100 hover:text-gray-900 rounded"
                                    role="menuitem">Profile</a></li>
                            <li><a href="{{ route('kajur.settings') }}"
                                    class="inline-flex items-center w-full p-2 hover:bg-gray-100 hover:text-gray-900 rounded"
    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-white border-e border-gray-200">
        {{-- <a href="{{ route('kajur.dashboard') }}" class="flex items-center ps-2.5 mb-5">
            ...
            <span class="self-center text-lg text-gray-800 font-semibold whitespace-nowrap ms-3">SIP-<span
                    class="text-emerald-700">S</span></span>
        </a> --}}
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="{{ route('kajur.data-master.dosen') }}"
                    class="flex items-center px-2 py-1.5 text-gray-700 rounded-lg hover:bg-blue-50 hover:text-blue-700 group {{ request()->routeIs('kajur.data-master.dosen') ? 'bg-blue-50 text-blue-700' : '' }}">
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-blue-700 {{ request()->routeIs('kajur.data-master.dosen') ? 'text-blue-700' : 'text-gray-500' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('kajur.data-master.mahasiswa') }}"
                    class="flex items-center px-2 py-1.5 text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 group {{ request()->routeIs('kajur.data-master.mahasiswa') ? 'bg-purple-50 text-purple-700' : '' }}">
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-purple-700 {{ request()->routeIs('kajur.data-master.mahasiswa') ? 'text-purple-700' : 'text-gray-500' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('kajur.data-master.atur-atribut-dosen') }}"
                    class="flex items-center px-2 py-1.5 text-gray-700 rounded-lg hover:bg-purple-50 hover:text-purple-700 group {{ request()->routeIs('kajur.data-master.atur-atribut-dosen') ? 'bg-purple-50 text-purple-700' : '' }}">
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-purple-700 {{ request()->routeIs('kajur.data-master.atur-atribut-dosen') ? 'text-purple-700' : 'text-gray-500' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('kajur.data-master.bidang-keahlian') }}"
                    class="flex items-center px-2 py-1.5 text-gray-700 rounded-lg hover:bg-teal-50 hover:text-teal-700 group {{ request()->routeIs('kajur.data-master.bidang-keahlian') ? 'bg-teal-50 text-teal-700' : '' }}">
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-teal-700 {{ request()->routeIs('kajur.data-master.bidang-keahlian') ? 'text-teal-700' : 'text-gray-500' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <li>
                <a href="{{ route('kajur.data-master.kepakaran') }}"
                    class="flex items-center px-2 py-1.5 text-gray-700 rounded-lg hover:bg-cyan-50 hover:text-cyan-700 group {{ request()->routeIs('kajur.data-master.kepakaran') ? 'bg-cyan-50 text-cyan-700' : '' }}">
                    <svg class="shrink-0 w-5 h-5 transition duration-75 group-hover:text-cyan-700 {{ request()->routeIs('kajur.data-master.kepakaran') ? 'text-cyan-700' : 'text-gray-500' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
                        viewBox="0 0 24 24">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
            ...
            <li>
                <a href="{{ route('kajur.verifikasi.seminar-proposal') }}"
                    ...
                    <span
                        class="inline-flex items-center justify-center w-4.5 h-4.5 ms-2 text-xs font-medium text-green-800 bg-green-100 border border-green-200 rounded-full">2</span>
                </a>
            </li>
